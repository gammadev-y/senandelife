...
export const createDefaultPlantStructureInternal = (input: PlantInput): Omit<Plant, 'id' | 'created_at' | 'updated_at'> => {
    ...
    return {
        latin_name_scientific_name: plantIdentificationOverview.latin_name_scientific_name,
        common_names: plantIdentificationOverview.common_names,
        plant_family: plantIdentificationOverview.plant_family,
        plant_type_category: plantIdentificationOverview.plant_type_category,
        description_brief: plantIdentificationOverview.description_brief,
        cultivar_variety: plantIdentificationOverview.cultivar_variety,
        growth_structure_habit: plantIdentificationOverview.growth_structure_habit,
        life_cycle: plantIdentificationOverview.life_cycle,
